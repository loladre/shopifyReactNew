...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ error = false, icon, className = "", ...props }, ref) => {
    const baseClasses =
      "w-full px-4 py-3 bg-white border rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 transition-all duration-200";
...
// Optional: for clearer component debugging
