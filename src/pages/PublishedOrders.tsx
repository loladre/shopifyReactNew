...
export default function PublishedOrders() {
  ...
  const fetchPublishedOrders = async () => {
    try {
      ...
      const response = await fetch(`${apiBaseUrl}${basePath}/shopify/published-purchase-orders-summary`, {
        headers: {
      ...
      <Layout title="Published Orders">
        <div className="w-full px-6 py-6">
          <Card className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-2">Error Loading Published Orders</h3>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setSearchFilters(prev => ({ ...prev, productStyleNumber: e.target.value }))}
                        placeholder="Any"
                        className="text-sm py-1"
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setSearchFilters(prev => ({ ...prev, variantSku: e.target.value }))}
                        placeholder="Any"
                        className="text-sm py-1"
                      />
                    </div>
