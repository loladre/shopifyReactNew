...
export default function Returns() {
  ...
  const filterProductsByReason = () => {
    if (selectedReason === "All") {
      ...
      setFilteredProducts(
        returnedProducts.filter((product) =>
          product.reasons.some((reason) =>
            reason.toLowerCase().includes(selectedReason.toLowerCase())
          )
        )
      );
    }
  ...
  const totalRefundValue = returnedProducts.reduce((sum, product) => {
    return (
      sum +
      product.refundAmounts.reduce((refundSum, amount) => {
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-600 mt-1">
              Identify frequently returned products to address quality issues
            </p>
          </div>
        </div>
          ...
          <div className="lg:col-span-5 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <FormField label="Since Date">
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setSearchFilters((prev) => ({ ...prev, since: e.target.value }))
                        }
                        className="pl-10"
                      />
                    </div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setSearchFilters((prev) => ({
                          ...prev,
                          minReturns: parseInt(e.target.value) || 1,
                        }))
                      }
                    />
                  </FormField>
                    ...
                    <label className="flex items-center space-x-2 mt-3">
                      <input
                        ...
                        onChange={(e) =>
                          setSearchFilters((prev) => ({
                            ...prev,
                            inInventoryOnly: e.target.checked,
                          }))
                        }
                  ...
                  <FormField label="Action">
                    <Button onClick={fetchReturnReport} isLoading={isLoading} className="w-full">
            ...
            {!isLoading && returnedProducts.length === 0 && (
              <Card className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-2">
                  No Frequent Returns Found
                </h3>
                <p className="text-slate-600 mb-6">
                  No products meet the current return frequency criteria. This could indicate good
                  product quality!
                </p>
                    ...
                    {uniqueReasons.map((reason) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-xs text-slate-600">{percentage}% of all returns</div>
                        </div>
                      );
                    })}
                  </div>
