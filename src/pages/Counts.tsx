  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${apiBaseUrl}${basePath}/shopify/productTypeReport?season=${combinedSeason}`,
        {
          headers: {
            "Content-Type": "application/json",
          },
        ...
        <div className="w-full px-6 py-6">
          <Card className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-2">
              Error Loading Product Type Data
            </h3>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-slate-900">
              Product Type Counts:{" "}
              <span className="text-purple-600">{generatedSeason || "Select Season"}</span>
            </h1>
            ...
            {!productTypeCounts.length && !isSearching && (
              <Card className="text-center py-12">
                ...
                <p className="text-slate-600 mb-6">
                  Choose a season, brand, and year to view product type counts for that specific
                  season.
                </p>
            ...
            {isSearching && (
              <Card className="text-center py-12">
                ...
                <p className="text-slate-600">
                  Please wait while we fetch the product type information...
                </p>
              </Card>
            )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold text-slate-900">
                          {totalProductTypes > 0
                            ? (totalStyles / totalProductTypes).toFixed(1)
                            : "0"}
                        </span>
                      </div>
                    </div>
