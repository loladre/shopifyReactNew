                ...
                <div className="flex items-center space-x-3">
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => setOrder({...order, purchaseOrderCompleteReceive: e.target.checked})}
                  ...
                  {isEditingSeason && (
                    <div className="space-y-2">
                      ...
                      <div className="flex space-x-2">
                        <Button size="sm" onClick={() => setIsEditingSeason(false)}>Save</Button>
                        <Button size="sm" variant="outline" onClick={() => setIsEditingSeason(false)}>Cancel</Button>
                      </div>
                    </div>
                  )}
                  <div className="flex items-center space-x-2">
                ...
                <div className="space-y-4">
                  ...
                  {isEditingCancelDate && (
                    <div className="space-y-2">
                      ...
                      />
                      <div className="flex space-x-2">
                        <Button size="sm" onClick={() => setIsEditingCancelDate(false)}>Save</Button>
                        <Button size="sm" variant="outline" onClick={() => setIsEditingCancelDate(false)}>Cancel</Button>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span>Received: {order.totalVariantReceivedQuantity}/{order.totalVariantQuantity}</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      ...
                      <FormField label="Description">
                        <Input
                          ...
                          onChange={(e) => updateNewCredit(index, 'creditDescription', e.target.value)}
                      ...
                      <FormField label="Amount">
                        <div className="flex space-x-2">
                          <Input
                            ...
                            onChange={(e) => updateNewCredit(index, 'creditAmount', parseFloat(e.target.value) || 0)}
                            placeholder="0.00"
                          />
                          <Button
                            variant="danger"
                            size="sm"
                            onClick={() => removeNewCredit(index)}
                          >
                            <X className="w-4 h-4" />
                          </Button>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <FormField label="Description">
                        <Input
                          ...
                          onChange={(e) => updateNewPayment(index, 'paymentDescription', e.target.value)}
                      ...
                      <FormField label="Amount">
                        <Input
                          ...
                          onChange={(e) => updateNewPayment(index, 'paymentAmount', parseFloat(e.target.value) || 0)}
                          placeholder="0.00"
                        />
                      </FormField>
                      ...
                      <FormField label="Invoice Number">
                        <div className="flex space-x-2">
                          <Input
                            ...
                            onChange={(e) => updateNewPayment(index, 'paymentInvoiceNumber', e.target.value)}
                            placeholder="Invoice #"
                          />
                          <Button
                            variant="danger"
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold">{formatCurrency(calculateTotalPayments())}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-600">Credits:</span>
                      <span className="font-semibold">{formatCurrency(calculateTotalCredits())}</span>
                    </div>
                    <hr className="border-slate-200" />
                    <div className="flex justify-between items-center text-lg">
                      <span className="font-semibold text-slate-900">Total Balance Due:</span>
                      <span className="font-bold text-slate-900">{formatCurrency(calculateBalanceDue())}</span>
                    </div>
                  </div>
                </div>
              </Card>
