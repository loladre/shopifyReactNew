...
export default function DraftOrderDetail() {
  ...
  const fetchOrderDetail = async (purchaseOrderId: string) => {
    try {
      ...
      const response = await fetch(
        `${apiBaseUrl}${basePath}/getDraftOrderById/${purchaseOrderId}`,
        {
          headers: {
  ...
  const handleDeleteOrder = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${apiBaseUrl}${basePath}/deleteDraftPurchaseOrderById/${order.purchaseOrderID}`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handlePublishOrder = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${apiBaseUrl}${basePath}/publishDraftOrderById/${order.purchaseOrderID}`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
