...
export default function NewArrivals() {
  ...
  const averagePrice = totalProducts > 0 
    ? tableData.reduce((sum, item) => sum + item.price, 0) / totalProducts 
    : 0;
      ...
      <Layout title="New Arrivals">
        <div className="w-full px-6 py-6">
          <Card className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-2">Error Loading New Arrivals</h3>
      ...
      <div className="w-full px-6 py-6 space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-600 mt-1">View products that arrived within the selected date range</p>
          </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            {!isLoading && arrivals.length === 0 && !isSearching && (
              <Card className="text-center py-12">
                ...
                <p className="text-slate-600 mb-6">
                  No products were found for the selected date range. Try adjusting your search dates.
                </p>
            ...
            {isSearching && (
              <Card className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-2">Searching New Arrivals</h3>
                <p className="text-slate-600">Please wait while we fetch products for the selected date range...</p>
              </Card>
            )}
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {filteredArrivals.map((brandData, index) => {
                      const brandTotal = brandData.products.reduce((sum, product) => sum + product.price, 0);
                      const brandAverage = brandData.products.length > 0 
                        ? brandTotal / brandData.products.length 
                        : 0;
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold text-slate-900">
                          {totalBrands > 0 ? (totalProducts / totalBrands).toFixed(1) : '0'} products
                        </span>
                      </div>
                    </div>
                  </div>
